...
/**
 * @OA\Schema(
 *     schema="ProdutoAtualizarValidation",
 ...
 * )
 */
class ProdutoAtualizarValidation extends FormRequest
{

    public function rules(): array
    {
        return [
            'id_categoria' => 'sometimes|integer|exists:material_categoria,id_categoria',
            'id_unidade'   => 'sometimes|integer|exists:material_unidade,id_unidade',
            'descricao'    => 'sometimes|string|max:150|unique:material_produto,descricao,'. $this->route('id'). ',id_produto',
            'codigo'       => 'sometimes|string|max:15|unique:material_produto,codigo,'. $this->route('id'). ',id_produto',
