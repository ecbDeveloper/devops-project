 ...
 * )
 */
class PetAtualizarValidation extends FormRequest
{
    public function rules() : array
    {
        return [
            ...
            'data_acolhimento'           => 'sometimes|date',
            'sexo'                       => 'sometimes|string|in:M,F',
            'caracteristicas_especificas'=> 'sometimes|string|max:250',

            'foto'                       => 'sometimes|file|mimes:jpeg,jpg,png|max:5120',

            'id_pet_especie'             => 'sometimes|integer|exists:pet_especie,id_pet_especie',
            'id_pet_raca'                => 'sometimes|integer|exists:pet_raca,id_pet_raca',
            'cor'                        => 'sometimes|string|in:' . implode(',', PetCorEnum::values()),
        ];
    }
