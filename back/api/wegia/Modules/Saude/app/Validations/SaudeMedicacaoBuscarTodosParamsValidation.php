...
class SaudeMedicacaoBuscarTodosParamsValidation extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ordenacao' => 'sometimes|string|in:medicamento,dosagem,horario,duracao,status',
            'tipoOrdenacao' => 'sometimes|string|in:ASC,asc,DESC,desc',
            'pagina' => 'sometimes|integer|min:1',
            'itensPorPagina' => 'sometimes|integer|min:1',
            'status' => 'sometimes|string|in:Tratamento,Concluido,Substituido,Cancelado',
        ];
    }
